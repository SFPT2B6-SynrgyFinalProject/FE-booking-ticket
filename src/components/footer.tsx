...
export default function Footer() {
    return (
        <footer className="bg-blue-200  shadow">
            <div className="w-full mx-auto p-6 text-center  max-w-screen-xl">
                <div className="mt-10">
                    <h1 className="block font-Outfit lg:text-3xl sm:text-xl font-semibold leading-11 text-white xl:text-center sm:text-center">
                        LET'S WORK TOGETHER
                    </h1>
                </div>
                <div className="mt-10 ">
                    <button
                        className="bg-white  text-gray-600 text-start  py-4 px-6 rounded focus:outline-none focus:shadow-outline w-[362px]"
                        type="button"
                    >
                        Contact Us
                    </button>
                </div>
                <div className="mt-10 mb-5 grid md:grid-cols-1 lg:grid-cols-4 gap-3 text-white">
