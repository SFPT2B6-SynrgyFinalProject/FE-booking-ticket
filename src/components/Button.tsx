...
const Button: React.FC<ButtonProps> = ({ children, type = 'primary', color = 'primary-normal', size = 'base', width = 'default', icon, className, ...rest }) => {
    const sizeClasses = {
    ...
    const buttonClasses = classNames(
        ...
        className, // Add custom classes
        {
            ...
            'cursor-not-allowed !bg-transparent border-[#d3d3d3] opacity-70 text-[#d3d3d3]': rest.disabled && type === 'tertiary',
